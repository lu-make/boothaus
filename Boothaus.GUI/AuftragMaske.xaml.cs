...
public partial class AuftragMaske : ThemedWindow
{
    ...
    public AuftragMaske(LagerApplicationService service, Lagerauftrag? auftrag)
    {
        ...
        if (auftrag is not null)
        {
            ...
            VonDatumEditor.Date = auftrag.Von;
    ...
    private void PropertiesSetzen()
    {
        ...
        Von = VonDatumEditor.Date;
        Bis = BisDatumEditor.Date;
    }

    private void ValidationTexteLeeren()
    {
        Bootliste.BorderBrush = default;
        VonDatumEditor.BorderBrush = default;
        BisDatumEditor.BorderBrush = default;
    ...
    private bool DatenValidieren()
    {
        if (!Von.HasValue || !Bis.HasValue || !Lagerauftrag.IstGültigesDatumspaar(Von!.Value, Bis!.Value))
        {
            ...
            VonDatumEditor.BorderBrush = new SolidColorBrush(color: Colors.Red);
            BisDatumEditor.BorderBrush = new SolidColorBrush(color: Colors.Red);
            return false;
        }
